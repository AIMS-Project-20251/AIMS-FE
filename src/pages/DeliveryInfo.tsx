...
const MOCK_ITEMS = [
  { productId: 1, quantity: 2, name: "300 bài code thiếu nhi" }, 
  { productId: 2, quantity: 1, name: "CD siêu nhân Gao" },
];
...
const handleCalculateFee = async () => {
  try {
    const payload: CreateOrderDto = {
      ...
      phone: form.phone || "0987654321",
      shippingAddress: form.shippingAddress || "Vietnam",
  ...
  useEffect(() => {
    console.log("Đang đổi thành phố sang:", form.city);
    handleCalculateFee();
  }, [form.city]);
